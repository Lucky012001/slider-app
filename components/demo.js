...
import tablet from "../public/tablet-16336.png"
...
const HoverScrollImage = () => {
  return (
    <>
       <Image src={tablet} alt="img" className={styles.container} style={{width:"313px", height:"680px"}}/>

        <div src={tablet} alt="img"
        ...
        >
          ...
          <div className={styles.imageContainer}>
            <Image
              src={img_1} // Path to the image in the public directory
              alt="My Image"
